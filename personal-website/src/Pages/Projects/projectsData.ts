...
export const projectsData: { [key: string]: Project[] } = {
    programming: [
      ...
      { id: 6, title: 'DisneyTriviaApp', description: 'A command line tool used to generate the shortest flight route using the Dijistra shortest path algorithm. Accounts for distances between airports and available flight connections, to deliver the optimal travel path.', 
